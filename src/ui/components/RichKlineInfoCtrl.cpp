...
RichKlineInfoCtrl::RichKlineInfoCtrl(RichKlineCtrl* pKlineCtrl,long x,long y,long w,long h) {
    //ctor
}
...
KlineItem RichKlineInfoCtrl::GetCurrentKlineInfo() {
    int n;
...
KlineItem RichKlineInfoCtrl::GetPrevKlineInfo() {
    int n;
    if(m_pKlineCtrl->m_crossLine == NO_CROSS_LINE) {
        n = m_pKlineCtrl->m_klines.size()-1;
    } else {
